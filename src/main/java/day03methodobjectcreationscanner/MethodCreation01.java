...
public class MethodCreation01 {
    ...
    public static void main(String[] args) {
        ...
        double alan = cemberCevreHesabi(3);
        System.out.println("alan = " + alan);


        double cevre = cemberAlanHesabi(4);
    ...
    //Homework
    //1) çemberin cevresini hesaplayan methodu hesaplyan methodu olusturup kullanız

    public static double cemberCevreHesabi(double r){
        return 2*3.14*r;

    }
   // 2) dairenin alanını hesaplayan methodu olusturup kullanın
    public static double cemberAlanHesabi(double r){
        return 3.14*r*r;
    }
